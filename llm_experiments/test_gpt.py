...
from llm_tools.wrappers import fetch_api_patient_appointment # qui importo la funzione wrapper che chiama la funzione reale per prendere i dati del paziente, è importante che questa funzione sia ben definita e aggiornata con tutte le funzionalità necessarie per interagire con le API del sistema, ad esempio gestire errori, formattare i dati, ecc.
